...
!=========================================================================
!     TEMP CHP Add printout for NUPTAKE variables

      CHARACTER*11 OUTNU  !NUPTAKE.OUT
      INTEGER NOUTDG, ERRNUM, YRPLT, YEAR, DOY, DAS, YRDOY, DAP, TIMDIF
      LOGICAL FEXIST
...
!=========================================================================
!     TEMP CHP Add printout for NUPTAK variables

!       Initialize daily root growth output file      
        INQUIRE (FILE = OUTNU, EXIST = FEXIST)
        IF (FEXIST) THEN
          OPEN (UNIT = NOUTDG, FILE = OUTNU, STATUS = 'OLD',
     &      IOSTAT = ERRNUM, POSITION = 'APPEND')
        ELSE
          OPEN (UNIT = NOUTDG, FILE = OUTNU, STATUS = 'NEW',
     &      IOSTAT = ERRNUM)
          WRITE(NOUTDG,'("*N UPTAKE OUTPUT FILE")')
        ENDIF
  ...
  200   FORMAT('@YEAR DOY   DAS   DAP',
     &  '        TRNU       ANDEM         NUF      NDMTOT      NDMSDR',
     &  '     RNO3U_1     RNO3U_2     RNO3U_3     RNO3U_4',
     &  '     RNO3U_5     RNO3U_6     RNO3U_7     RNO3U_8',
     &  '     RNH4U_1     RNH4U_2     RNH4U_3     RNH4U_4',
     &  '     RNH4U_5     RNH4U_6     RNH4U_7     RNH4U_8')
