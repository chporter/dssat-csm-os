...
Subroutine CsvOutSumOpsum(RUN, TRTNUM, ROTNO, ROTOPT, REPNO, CROP, MODEL, &
   ...
   DAYLA, CO2A, PRCP, ETCP, ESCP, EPCP, CRST, AMLCH, N2EH, NOEH, RNROH, Csvline, pCsvline, lngth) 
...
!  Input vars
   ...
   Real, Intent (IN) :: AMLCH, N2EH, NOEH, RNROH
...
!  Recalculated vars
   ...
   SRADA, DAYLA, CO2A, PRCP, ETCP, ESCP, EPCP, CRST, AMLCH, N2EH, NOEH, RNROH
