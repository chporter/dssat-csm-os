...
! CHP NOTES: 2020-01-31 
! I don't have time to work on it now, but:
!   SW should not be updated here. Put in a delta variable (SWDELTC?)
!   Be careful about upflow calculations. Suleiman-Ritchie routine already
...
!   Capillary flow    
    CALL Capillary(DYNAMIC,                    &
         SWDELTU, ActWTD, RWU, SOILPROP, SW,  &        !Input
         Capri)                                         !Output
